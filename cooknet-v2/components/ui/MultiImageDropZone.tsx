...
import { UploadCloudIcon, X, XCircle } from "lucide-react";
...
type InputProps = {
  ...
  onFileDelete: (removedFile: string | File) => void | Promise<void>;
  disabled?: boolean;
  ...
  (
    ...
    return (
      <div className="flex justify-center items-center w-full flex-col">
        ...
        <div className="grid grid-cols-[repeat(4,1fr)] gap-2 sm:grid-cols-[repeat(4,1fr)] lg:grid-cols-[repeat(4,1fr)] xl:grid-cols-[repeat(6,1fr)]">
          {/* Images */}
            ...
            >
              ...
              {progress === "COMPLETE" && (
                <div
                  ...
                  className="absolute top-0 left-0 flex h-full w-full items-center justify-center rounded-md bg-black bg-opacity-50 hover:cursor-pointer"
                >
                  <XCircle className="" size={25} />
                </div>
              )}
              {/* Progress Bar */}
